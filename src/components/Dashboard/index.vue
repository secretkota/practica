...
const series = ref([{
    name: 'series-1',
    data: [30, 40, 45, 50, 49, 60, 70, 2000]
}]);
</script>
...
<template>
    <div class="p-4 border border-default border-dashed rounded-base">
        <div class="flex justify-center mb-4">
            <div class="flex items-center justify-center h-48 rounded-base bg-neutral-secondary-soft">
                <VueApexCharts class="w-full" type="bar" :options="options" :series="series">
                </VueApexCharts>
            </div>
        </div>
