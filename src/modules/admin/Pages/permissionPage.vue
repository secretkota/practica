  ...
  <div class="grid gap-6 min-h-130 transition-all duration-300 mt-5"
    ...
    <div :class="rolesStore.selectedRole ? 'col-span-5 space-y-4' : 'col-span-12 space-y-4'"
      ...
      <div class="p-4 rounded-base shadow-sm bg-white flex items-center justify-between">
        ...
        <button @click="openCreateForm" class="flex items-center gap-2 px-2 py-1 rounded-base
      ...
      <RolesForm :open="isOpenForm" :is-edit="isEdit" :role="editingRole" @close="closeForm" />

      <RolesList :is-edit="isEdit" @edit="openEditForm" />
    </div>

    <div v-if="rolesStore.selectedRole" class="col-span-7 rounded-base animate-fade-in transition-all duration-300">
